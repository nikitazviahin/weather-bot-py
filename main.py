...
TOKEN = '1549692242:AAFwhwi4_5gd-me4iFcHVGhz6lXUKShI8eI'
OWMKEY = '3a9dd797a682570073a3787478d12936'
...
def process_message(bot, u): #This is what we'll do when we get a message 
    ...
    if u.message.sender and u.message.text and u.message.chat: #if it is a text message then get it 
        ...
        obs = owm.weather_manager().weather_at_coords(u.message.location.latitude, u.message.location.longitude) #Create a weather observation 
        w = obs.weather #create the object Weather as w 
        print(w) # <Weather - reference time=2013-12-18 09:20, status=Clouds> 
        l = obs.location #create a location related to our already created weather object And send the parameters 
        status = str(w.detailed_status) 
